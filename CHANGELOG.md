...
## [1.34.0](https://github.com/nirmalhk7/CareerOpsVOYAGER/compare/career-ops-v1.33.0...career-ops-v1.34.0) (2026-09-24)


### Features

* add /calibrate — check evaluation scores against real outcomes ([#3315](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3315)) ([4934985](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/493498572b54c8fed6081281a1190690c01e3f55))
* **application-answers:** read the evaluation's Block H draft answers ([778d5bf](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/778d5bf15ceccbffab13284b7e5752d68aafd44e))
* **apply:** recover previous answers through --read --strict at the CLI seam ([75d6b2c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/75d6b2c64315a0820b4a78b254b1c649f3386aa3))
* **artifacts:** ATS form copy-paste plain-text exporter ([#2887](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2887)) ([9f79f09](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9f79f0921ee0ad2a62b55ab63456057a43831168))
* **batch:** add --cli flag for multi-CLI batch evaluation ([244d193](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/244d1933d5ee1ebd4999a7b796654043a477f2af)), closes [#737](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/737)
* **batch:** add --cli flag for multi-CLI batch evaluation (opencode, gemini, qwen) ([6255cc2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6255cc200be7aabe45bf1d5c2ec2e6f52337fd7f))
* **browser-extract:** read Greenhouse, Lever and Ashby JDs from their public APIs, and add fetch-jd.mjs ([#3654](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3654)) ([1923ee1](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/1923ee14b2edc635e6ea59a447d0f4fbce02ad48)), closes [#2582](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2582)
* clean-markers — audit/strip hidden Unicode from generated text outputs ([5fde72f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5fde72f80094c17a3539ecfc34b391c545b682a4))
* **cli:** add help flags to check-liveness ([#2576](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2576)) ([4f5934b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4f5934b9152098f2e6bfc66d1ca57fced9d6a07e))
* **cli:** application-artifacts.mjs honours --help ([#2774](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2774)) ([c265217](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c265217791abf606ee206d37f12ccb687e5c1739))
* **community:** PR adoption ladder for quiet PRs ([c86841b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c86841b87eb4e7f6cbdfcf3bc76672d9b7af8fb8))
* **community:** the Hired Wall, a verifiable ledger of people hired with career-ops ([#3372](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3372)) ([542491f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/542491fb65811331057987e6dc2734783a070464))
* **contacts:** linkedin-join.mjs — warm-intro finder from a LinkedIn connections export ([ba1a3dd](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ba1a3dd0b6630198b86bedad4ff642d88dc69ecb))
* **cv:** add "text" output_format — tailored markdown CV, no PDF ([#3342](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3342)) ([13de717](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/13de7175b176742573f31ca8221fa46acc3a92da))
* **cv:** add optional Interests section to the HTML CV template ([2e7f1df](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/2e7f1dfcc8a1082f9ab6a4e7c2a8ca9d86f1feab))
* **cv:** ATS-friendliness check — score a generated CV for parseability ([#2064](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2064)) ([6d4e4c7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6d4e4c75b1a60a2e907c648e667dea4d4d2b2a9d))
* **cv:** optional url support for projects in HTML and LaTeX ([93e256c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/93e256c416ced0127f22c8c4ae0302a6d7724a6f))
* **cv:** render an education entry's location on the HTML CV ([#3776](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3776)) ([8e5c65d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/8e5c65dfaedfe5d10d31926a72d79c0d9fef4a10)), closes [#3773](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3773)
* **detect-reposts:** skip multi-employer aggregator boards, and say why ([d6ac988](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d6ac988c6655c64f2fcb1170a4561640562b624c))
* **discard:** add discard-log analytics and tuning summary ([#3443](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3443)) ([8827f40](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/8827f4064bf6afe3e8922ec0b99ef74e74c7c99a)), closes [#3392](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3392)
* **doctor:** detect personalization files still carrying template content ([#2691](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2691)) ([0cdd935](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0cdd935c0d8a71a58121a625e2c18f5a2b86d8f0))
* external data directory via CAREER_OPS_ROOT ([#524](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/524)) — lands [#1444](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/1444) ([9159ec6](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9159ec6b34cdd1a3226d03c10d6f34c370175e56))
* **hired-wall:** a quiet chevron with the exact remainder says the strip continues ([87e3188](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/87e3188712ff5dda72013bb6ceffd9ca333d5bd7))
* **hired-wall:** anonymous cards carry sector · location, mirroring the credited-card hierarchy ([9f226e0](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9f226e00bf4c98cae8ad30a070ecec1b15372e37))
* **hired-wall:** the audit line speaks to the person mid-search ([c74dfc3](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c74dfc32a83e1c36aa3e264f887dc97efea6b0be))
* **hired-wall:** the badge is the title — self-identifying label, own share line, tighter audit line ([7280a48](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/7280a48731f337563435c756e2ec0754b5115d4c))
* **hired-wall:** verified-hires framing, one CTA line, anonymous silhouette, months parsing ([fb8d6a5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fb8d6a5acae19cffb53239b0f486a8407d8b00a7))
* **oferta/pdf:** enforce JD archival in every report ([4726e05](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4726e05312e40a1a9e2d61b2e4ccf6851fbd5a4e))
...
* **outcome:** add --clean-output to archive-then-remove tailored CVs ([#2653](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2653)) ([6ab969d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6ab969dade42de66b5b32badcb2dd5cca2ea6b00))
* **plugin:** add h1b-sponsor for DOL sponsorship history on US roles ([#2635](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2635)) ([11ae621](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/11ae621cc505a21d835abc751fa0e2ac8ac9959d))
* **plugins:** register career-ops-plugin-xquik (X hiring posts via Xquik, BYO-key) ([88b325c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/88b325c13026c14ab926398f5c7d451ce62a6cd5))
* **portals:** audit board content, not just reachability ([#3610](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3610)) ([9b896b5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9b896b50a426dd4c07b342f7b79253296aeea684))
* **portals:** profession-agnostic examples in portals.example.yml ([b8614f8](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/b8614f802a67bf6e7d2fcc402435c14464e5c005))
* **providers/getonbrd:** scan multiple categories per entry ([#3330](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3330)) ([2cc140a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/2cc140a7a86d99ea7e005339295bb825770dce76))
* **providers:** add Built In aggregator provider ([#3645](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3645)) ([291c301](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/291c301051f54936dd14d65200a1fd06db6c2989))
...
* **providers:** add Garena careers provider ([#3567](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3567)) ([d88cfe1](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d88cfe160cfc1637fe5b5562726726d00a020974))
* **providers:** add ITviec provider — first Vietnamese job source ([#230](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/230)) ([ecc9bdc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ecc9bdc3f20dc1e5036146ec684b38986dbb8ca6))
* **providers:** add the Gem Job Board REST API as a verified-URL mode alongside the GraphQL provider ([#3783](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3783)) ([0e5a95c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0e5a95c57d5a6fd40057d1ff7717e509c3524036))
* **providers:** add Torre opportunity-search provider ([#3328](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3328)) ([086c75a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/086c75a4c3b4a032b84c1d5bb95b3bc7d0ea3681))
* **providers:** CareerViet, second Vietnamese job source ([#3378](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3378)) ([e3d372b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e3d372b732424100faf39e37edc4a395e1d1dd98))
* **providers:** job.description for recruitee, ashby, and opt-in smartrecruiters ([#3175](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3175)) ([83d3ac6](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/83d3ac6afbd945cd101b319f4af3b885f445134d))
* **providers:** JobsDB Hong Kong via the existing jobstreet provider ([6fa8279](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6fa8279797e3b4dc90dfab38dad62359b1d0dc65))
* **providers:** mycareersfuture, Singapore's national job bank ([#230](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/230)) ([a726f53](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a726f538b17f0d6f237295f5429be2fab3f4365d))
* **providers:** telegram-channel, public channel posts via t.me/s/ (zero-auth) ([#3668](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3668)) ([ab4e5e4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ab4e5e4821ced4464f468b7a4f7687234d3c4e31))
* **scan:** add a durable machine-readable scan receipt ([#3532](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3532)) ([26f47d2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/26f47d2972b6a2bcf00c2aa707744691a0f0ec63))
* **scan:** add Apple and Microsoft providers ([199c06c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/199c06cb236c17849fac47076e61bab5850d2955))
* **scan:** add Collage HR public job provider ([#3787](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3787)) ([bf2b647](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/bf2b64779d659f19df24d82ccd768ab09432d389))
* **scan:** Notion already-applied gate for scan + pipeline ([4c37ae1](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4c37ae147d2255fb671cfbc851efe2a063f7852e))
* **scan:** one machine-findable marker line above every scan summary ([#3747](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3747)) ([339ee57](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/339ee57e5ac8e31baeb1ea09a12bab1ce3c1d6f6)), closes [#3560](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3560)
* **scan:** per-company title_filter_overrides for scan-ats-full.mjs ([#3710](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3710)) ([5fb18d7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5fb18d7cd2c2f3aa6d5c836eb1416be1d0d3cf5a)), closes [#3708](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3708)
* **scan:** remember permanently dead ATS boards ([#2869](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2869)) ([bf54f20](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/bf54f20eaf295808a037cac0c5dec2810798f4e9)), closes [#2840](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2840)
* **templates:** add ATS-friendly single-column CV template pack ([c958462](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c9584625e860f1f3bc00b93bc202afcf52de3502))
* **templates:** CJK support for the LaTeX/Overleaf CV path via tectonic ([#3554](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3554)) ([1b58724](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/1b5872460bf57cd810807ac33957c2f5104dd61c)), closes [#3553](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3553)
* **templates:** discover template packs by name ([#3202](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3202)) ([29e72bc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/29e72bc41d16db0a66be7bdf0a14b75af020f6f4))
* **title-filter:** a stem: prefix, for the half a plain keyword gives away ([77c7007](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/77c70077c6273ab65ffbcd6dafb43bd633c19632))
* **updater:** require confirmation before installation ([#2866](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2866)) ([f33b8e2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f33b8e2dfa88b02b13460332c3d09e152d8e3a7b)), closes [#2865](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2865)
...
* wire reply-watch into status-log.tsv ([#1582](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/1582)) ([f88df83](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f88df83934503418d77a8cbce4dc5942c5e18bb8))
* **wttj:** server-side Algolia filters so a scan can be exhaustive ([#3757](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3757)) ([c1df875](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c1df875c768071369045caaf8c79f06a2fbf3059))


### Bug Fixes

* **agent-inbox:** lock resolve rewrites so a concurrent add is never dropped ([#3479](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3479)) ([e26a8cc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e26a8cc23ca0dc5c4e7d00873347e690e2b6b2e6)), closes [#3478](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3478)
* **analysis:** funnel-velocity, calibrate and weekly-digest read the configured data root ([#3715](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3715)) ([d7ff406](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d7ff4062269f4f1afa38c6615561288ff314f343)), closes [#3714](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3714)
* **analyze-patterns:** parse report headers written in French ([#3808](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3808)) ([29f065f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/29f065f1bed9872574c8999343b0102e698b25f4)), closes [#3807](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3807)
* **analyze-patterns:** read archetype headers from every localized mode ([#3866](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3866)) ([9d182a9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9d182a9c2360fbabcfbb9e043fa96b359ef9255e)), closes [#3865](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3865)
* **analyze-patterns:** stop counting Applied as positive ([#3667](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3667)) ([f4df0c6](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f4df0c6ab0325ed42403759c7724456eba3b5c9f))
* **batch:** escape ampersands in offer URLs ([d2cd237](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d2cd23785a3364ab49d69481ecf8fd04e82f0c0a))
* **batch:** escape ampersands in offer URLs ([ad3b736](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ad3b736e1361e23ab661435279be04e43dfdb487))
* **batch:** parse scores locale-independently in batch-runner ([f24eac2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f24eac20c424aaaf11d038f9e00818ce6f6f631d))
* **batch:** parse scores locale-independently in batch-runner ([1949187](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/19491874c2f618003aa7382fdd3fe3d19deba46e))
* **browser-extract:** read Workday JDs from the CXS API, and fail loudly on an empty JD ([#3256](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3256)) ([55af9fc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/55af9fc715eeb50825f3f710774a96a950e65726))
* **build-cv-latex:** render markdown bold in bullets as \textbf ([#3351](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3351)) ([f1cc17b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f1cc17bdb7938a29fa64f5fa28ec5bbac43c3ff4))
* **calibrate:** read all 14 outcome spellings outcome.mjs writes ([#3322](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3322)) ([9db4458](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9db4458b8f9abba9d0f5c994e3b2a766854d0a56))
* **calibrate:** resolve the tracker colmap from the line array, not the header line ([#3496](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3496)) ([abaf075](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/abaf07565ba888d181cf8d1d094610f3c0c3e1f1)), closes [#3495](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3495)
* **check-jd-archive:** credit jds/ captures named by a tracker row ([5bcaddc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5bcaddc7fb2cceed869780b4fe36e2786a42e7d3))
* **check-jd-archive:** credit jds/ captures named by a tracker row ([3f9a3fc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3f9a3fc846ffcbb5b06b5c79e1e61d312ad5681a))
* **check-jd-archive:** reject login-wall/404/paywall/JS-shell text as non-content ([#3837](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3837)) ([3834b91](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3834b91843b903734447633f66fdefd41a42a3d1)), closes [#3829](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3829)
* **ci:** check out base before running labeler ([eaf10ad](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/eaf10adb3b34c79554f5b422c8bc9b9c5eaf23ac))
* **ci:** check out base before running labeler ([a20f181](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a20f181da39e8d9612a1d950b9268780b9f14bf0))
* **classify-tier:** Associate + an academic rank is not entry-level ([#3178](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3178)) ([ef347fb](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ef347fb26c636a4d7dd84727744f34356311217e))
* **cli:** close the missing-operand hole for value-taking flags ([#3087](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3087)) ([201aeca](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/201aeca286784829062430e680089268e66d29e4))
* **cli:** validate analyze-patterns flags through lib/cli-flags.mjs ([#3848](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3848)) ([4d82beb](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4d82beb4d3fc40baaef5a1f5d5817b9f797879a8)), closes [#2979](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2979)
* **cli:** validate flag values in detect-reposts via the shared safeIntFlag ([50944e3](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/50944e35e174410508d3369fed075a2e4ac456ea))
* **contacto:** stop searching for contacts the mode never uses ([17f5557](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/17f55577fe315392ca557419bace93d2b2c53ff6))
* **coverage:** exclude the local-paths declaration file so a fork can commit it ([280044e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/280044e1fe14e9b25f067324bf7a87ba9828649f))
* **cv-sync-check:** resolve prompt paths from CODE_ROOT instead of an undefined projectRoot ([d6df7a2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d6df7a290581d186f46f94969c1b52fa1a68f8aa))
* **cv-sync-check:** stop allowFail from excusing an uncaught crash ([a19da42](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a19da42dc6f71c17f52d5b907ea7980429576851))
* **cv,pdf:** address CodeRabbit review feedback for [#2213](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2213) ([8c08b76](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/8c08b765fd8a4a0e77b671d8e4b2fb2c47653888))
* **cv:** block delegated authorship escalation ([#3657](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3657)) ([08bdb3f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/08bdb3f184f4abf7b355915609a71985d30c1881))
* **cv:** reject CV payloads whose section keys the builders never read ([#3524](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3524)) ([9f6efb5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9f6efb5c73d890675c269099fd1b182d3d6ddb42)), closes [#3523](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3523)
* **cv:** render the ATS template's contact row ([#3838](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3838)) ([e1aebed](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e1aebed5bb6fd6d55e1cf47808bded623a0e4b48)), closes [#3775](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3775)
* **dashboard:** match company slugs at hyphen boundaries so Meta cannot open Metabase's CV ([#3483](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3483)) ([f5e2753](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f5e27531e866514441bcd6f9e03b56db93b93c91))
* **dashboard:** read job URLs from the tracker before the legacy enrichment tiers ([c124fb6](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c124fb668e594f92d78d6ff8d178a48ffa90f908))
* **dashboard:** serve:dashboard respects CAREER_OPS_DATA_DIR ([#3929](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3929)) ([b4bd6aa](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/b4bd6aa27582f1659085a5804f3c8cd5751eff18)), closes [#3924](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3924)
* **data-root:** resolve templates/states.yml from the codebase, not the data root ([#3503](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3503)) ([be61f60](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/be61f60be88aed8277cef2f498140c098517e65e))
* **dates:** weekly-digest and rejection-latency read the local day, not the UTC day ([c8200cb](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c8200cbbd0757fe9ed7594192daac049f443add3))
...
* **discover-ats:** a refused redirect is an answer, not a status to re-run ([#3804](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3804)) ([80885c9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/80885c9c45d288e3a86fa043db635d755afb1630))
* **doctor:** detect project-scoped Playwright MCP plugin installs ([#3711](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3711)) ([719d1a4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/719d1a4c64735fec4eb6f5f4b1616db4d181476c))
* **doctor:** keep git's "not a git repository" off stderr in --json ([#3722](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3722)) ([8058eba](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/8058ebac18f248a36efa1dedcfac0a8ea9779b99)), closes [#3721](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3721)
* **doctor:** make CLI-resolution tests hermetic against a repo .env ([#2617](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2617)) ([95225c1](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/95225c1be267116f44d5758b85e20c029602d33b))
* **doctor:** surface tracked .bak backup files as a warning ([228e7b8](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/228e7b8078804d82c92f2497ea2ec340b7fc0cae))
* **doctor:** survive a null entry in installed_plugins.json ([0a137a1](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0a137a14c936d83a81f537661417e04ada2e37a5))
* **email:** align fit points with the tailored CV via the pdf-index row ([#3473](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3473)) ([d08aac2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d08aac29e33775245f70d1f5b9a781103f40777d)), closes [#3460](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3460)
* **eval:** parse the score in gemini-eval instead of concatenating it ([#3799](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3799)) ([eedc6d9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/eedc6d921c2988cfc26fca930044f731292db2c0)), closes [#3707](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3707)
* **eval:** persist openai/ollama evaluations as tracker additions ([#3797](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3797)) ([090c2b4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/090c2b4b89b762e32b53e191da06883d82e1f559))
* **fact-gate:** a non-English CV inflating headcount returns 'pass' — say so instead ([#3320](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3320)) ([fa13474](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fa13474f5a74d3d66af5dfb57f9cdf6f8fadc39c))
* **fact-gate:** count education and training nouns as metrics ([#3646](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3646)) ([12b1a4a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/12b1a4a2f54cdabfa33faf35519c55e255899155))
* **followup-cadence:** accept --json, the flag both web follow-up routes pass ([#3862](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3862)) ([57de2ea](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/57de2ea1c9dd9d891959926d5e00c2411c05ff60))
* **followup-cadence:** validate CLI flags via the shared helper ([#3196](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3196)) ([ec800a2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ec800a2c7539ee394b89eb6d6434a3f2f61de84a))
* **followup:** stop reporting the candidate's own address as a contact to chase ([c0fe77e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c0fe77e2e497552ff1b994a79f9d7d6f9ab182d0))
* **followup:** stop truncating plus-addressed emails at the plus ([9d4817c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9d4817c07f944b352ffba6f68131c10b3902fe82))
* four defects invisible in the maintainer's own checkout ([7f72883](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/7f72883d3965430db6aacb264a18be77c5e8358d))
* **funnel-velocity:** fold status-log history into calibration rates ([#3494](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3494)) ([369db53](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/369db538ccf4c62eff5de890433a9e00805b6d41)), closes [#3493](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3493)
* **garena:** route id encoding through _safe-url so one bad posting drops, not the page ([7bee848](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/7bee8480f4a3571d47fd9b2ba888122a21e52c0c))
* **gemini-eval:** write the **URL:** report header so its rows reach the URL dedup key ([#3876](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3876)) ([f8e9201](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f8e9201f2cd0f55f82291482ca57ea313037a8c5)), closes [#3795](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3795)
* **gemini:** resolve encoding mojibake on Windows and route localized modes ([#1443](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/1443)) ([3f54486](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3f54486e540a74ef1a6eca81f2bda9ab59bc7ca4))
* **gfi-claims:** reply when /assign is used outside the claim pool ([f0b24df](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f0b24dfa5198d3ecf5c7394ff9777b20872b8950))
* **gitignore:** ignore the tracker and follow-ups file in the legacy root layout ([#3718](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3718)) ([fc8ee60](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fc8ee60419a56804924f00e7cde7f040a4effc41)), closes [#3717](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3717)
* **gitignore:** the tracker's derived SQLite index is unignored outside data/ ([#3468](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3468)) ([bc5771a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/bc5771a12fab34ce28b66856be54ece6504b6e3a))
* **gmail:** skip page assets so logos stop landing as job leads ([#3649](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3649)) ([c172fd8](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c172fd8993862f5ad99dfdf6dc67f3cc650d087f))
* handle quoted angle brackets while stripping HTML tags ([702a2ae](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/702a2ae4c590f28a140b5fa845818a356b57c22f))
* harden context budget prompt assembly ([#3591](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3591)) ([1be498d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/1be498d177cf8a52e6f7affe2d00f12baf552394))
* **harness:** make the syntax gate recursive, shared with npm run lint ([43f846c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/43f846ca49587a8507af2db5c8af76d7a11ba7b5))
* **hired-share:** suggest outcome.mjs's real syntax in the no-Hired-row error ([4a69583](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4a69583146723b5dd753185ae0d0ca029e03534c))
* **hired-wall:** ellipsize single-line card rows instead of clipping at the viewBox ([61dd811](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/61dd8113a096488933603bc576a47c763b6cf97e))
* **hired-wall:** honor both permission wordings and default public stories to full credit ([f65ba5e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f65ba5ed0a358cd600c621234c284be162f9a670))
* **i18n:** preserve safety guardrails in localized modes ([3afc54d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3afc54d1f7921a0ab99fcb02b5fc383014ec956d))
* **icims:** read every jobLocation entry when picking the location ([#3728](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3728)) ([d5a5bc9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d5a5bc90a84e128ad095ad0775535187c73dcf05)), closes [#3727](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3727)
* improve error message for missing cv.md ([602ac8b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/602ac8b635ecf48b5c9068214666fa0c5c283ba2))
* **invite-match:** extract company names in any script, not just ASCII ([#3864](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3864)) ([48513e7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/48513e7951765161ce9ea5c51bc5d43222abd33a)), closes [#3861](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3861)
* **invite-match:** resolve set-status.mjs from the code root, not the data root ([cfc6b01](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/cfc6b0190eac5a1c919aefeb28a008a97b4d8864))
* **invite-match:** resolve set-status.mjs from the code root, not the data root ([5c65257](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5c652575fd43e818ee0f1be7dc0aff646a3e773e))
* **invite-match:** stop extractReqId backtracking quadratically ([#3463](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3463)) ([637e7eb](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/637e7eb718d7ac1a2bb19706b892b07e7f636b78))
* **jd-skill-gap:** improve error message for missing cv.md ([f783f0a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f783f0a64e1cf6b57db43dc36af762ec476b9e13))
* **jd-skill-gap:** recognize Traditional and Simplified Chinese requirement headings ([#3631](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3631)) ([08e8747](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/08e8747fe0a77756db54b0f88bd3e8dc45b8c58a))
* **jd-skill-gap:** resolve cv.md against the data root ([680f847](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/680f847d9c58486240141c8b5002b26797ea7e2d))
* **jd-skill-gap:** resolve cv.md against the data root ([#4209](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/4209)) ([4795dc1](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4795dc19b8b9a232860c29d8c89210f2efa97277))
* **jobbankca:** count raw entries for pagination ([#3249](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3249)) ([19b7314](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/19b7314d06a1a03a2ab3f8bbcafd20b06d83e4c6))
* **linkedin-join:** use the real people-search route ([#3811](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3811)) ([b2aa0a9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/b2aa0a976926952e874e7f5bf264ad3e3bdce072))
* **liveness:** add a LinkedIn rung so LinkedIn postings get a real verdict ([#3179](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3179)) ([255bfc9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/255bfc940479574da5ab363665b6a64a8dfdeadd))
* **liveness:** stop reusing the headed page after its browser closes ([0baa692](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0baa692755d2d3c1aa3d747910853683dcfbd0f9))
* **liveness:** stop reusing the headed page after its browser closes ([17d83e9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/17d83e942502e90a41abe459f5b86f65ef747114)), closes [#4176](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/4176)
* **locks:** one recovery judgment, imported by all three copies ([638fdc4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/638fdc4edf2dbce2e6e59c998520ce5962a23d47))
* **merge-tracker:** --backfill-urls rebuilds unfillable rows to full header width ([#3381](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3381)) ([d6435ef](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d6435efe6e73b05629b1cddb6f4ba734c5b29191))
* **merge-tracker:** --help exits early and post-merge hooks resolve from the code root under an external data root ([#3761](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3761)) ([7a75b99](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/7a75b994cb1136513c1353403cd571e30cca9f69))
* **merge-tracker:** a corporate-form merge keeps the row's employer name and prefers an exact company match ([#3812](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3812)) ([fd6cf93](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fd6cf935776fcf8b15be0ad94475747aac55053e))
* **merge-tracker:** a corporate-suffix variant is the same employer ([#3666](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3666)) ([a4f5276](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a4f52765f1920c353933984ff5ed71da50bedf36)), closes [#3665](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3665)
* **merge-tracker:** two '?' rows with no Via silently merge, overwriting one ([#3466](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3466)) ([8f22538](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/8f22538a1458ee7fe5ad0da70183facf72361d90)), closes [#3410](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3410)
* **meta:** point CITATION.cff and package.json at career-ops.org, and stop the blurb drifting across five files ([2c76ca4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/2c76ca434555dee6bf6236573225f257bbbdca24))
* **oferta:** lead Block B with the decisive columns and freeze their order ([#3660](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3660)) ([abc5a89](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/abc5a893a61b752b1e410d5145c044b82638f0d2))
* **ollama-eval:** stream the response and make num_ctx configurable via OLLAMA_NUM_CTX ([#3922](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3922)) ([fe06051](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fe06051ba57c78934b89355bebe2c67f3a5cdb14))
* **openai-eval:** stream the evaluation call instead of a single buffered response ([#3501](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3501)) ([ee6e8f6](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ee6e8f63ce6f1a62d64e22a9fb37c28b2a000429))
* **openrouter:** write scan-history and pipeline through the shared locked writers ([#3462](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3462)) ([81e27c5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/81e27c5e9b6225b73383dea4f9fe464977821123))
* **outcome:** a tracker edit forks the append-only journal, and directory order decides which half counts ([#3325](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3325)) ([ba2b409](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ba2b409d1dbd55160499f5f1c69731bc5bd8e61d))
* **pdf:** accept the canonical modes/pdf.md tailoring order in validateCvSectionOrder ([#3642](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3642)) ([a9c957c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a9c957caedea5dbdc17d165d072dd66d330b42d4))
* **pdf:** enforce workspace boundary in direct renderer ([a4706e3](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a4706e3b9f6ef4ce2bc6a470ccfb1e60e56c4c82))
* **pdf:** name both sides when the lexical containment check fires ([#3162](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3162)) ([98cc650](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/98cc6501e739d992e83436b366020cebc1592819))
* **pdf:** recognize Chinese section titles in SECTION_ALIASES ([#3803](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3803)) ([49b6586](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/49b6586e5212e7d5e8553e6189f8978484a05387)), closes [#3658](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3658)
* **pdf:** run the CLI when reached through a symlink ([#3170](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3170)) ([3c2fa60](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3c2fa6083976777bd69ecb24d697d5ebc3551a09))
* **pdf:** run the fact gate before rendering a CV ([#3647](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3647)) ([1b299fa](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/1b299faa659c782d2385c4119191c382a0b01dea))
* **pdf:** stop the batch-evaluate fixture leaking its tracker env ([#3162](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3162)) ([328fd38](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/328fd387df5b7f8f9ede17562c2dd7d932db7247))
* **pipeline:** use browser-first LinkedIn extraction ([e0f0f33](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e0f0f33630e713401c907e4123feb7edd070a3c8))
* **plugin-install:** add --help and reject unknown flags ([#3857](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3857)) ([45f11b7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/45f11b7b9058ec035a3bf3ba251322a2d9fdb392))
* **plugins:** a YAML typo in plugins.yml no longer destroys the whole config ([#3593](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3593)) ([00f185d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/00f185d672dd7bf2499f5a3ae7ee7be340493da3)), closes [#3592](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3592)
* **plugins:** isolate cmdRun results to the requested plugin id ([#2354](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2354)) ([f0044f8](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f0044f8c7890bd7069a64a61639a90130c86c67b))
* **plugins:** scale export hook timeout with tracker size ([a8cbb2d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/a8cbb2df20ec61227dc5cd50dbeaed2526893b70))
* **portals.example:** drop retired EchoJobs block ([3254ea3](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3254ea39d585c609dde826051237529c93ee7691))
* **portals:** sweep and validate job_boards, not only tracked_companies ([#3448](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3448)) ([2c5894e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/2c5894e0a4a74146bf04b8c8532e338d45a131ea))
* **providers/icims:** fill a missing location from the posting's JSON-LD ([20ec88f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/20ec88fdacec63a9a3d29ca3b5ed9c07e33dfaea))
* **providers:** a lone surrogate in one id/slug no longer aborts the whole page ([7cdd684](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/7cdd6845278948b4d8379fb2fcebf39304e54994))
* **providers:** a lone surrogate in one id/slug no longer aborts the whole page ([d76bea0](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d76bea0e1c3f9a8f3aab20ce583812774ceda23c))
* **providers:** a16z treats a non-positive total_pages as absent, not as one page ([002307f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/002307f6ade85e805a486e6a9847b1014f1bb1ad))
* **providers:** apply default headers case-insensitively ([b12016b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/b12016be15aeddf780ffc30a0010371a140c4319))
* **providers:** coerce before the try; drop tkms encode of the config locale ([94eebce](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/94eebced04e524572e201ee65df275a60f370771))
* **providers:** pin accept-encoding so zstd bodies are not truncated ([2049537](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/2049537c420e396d08425c6950203718cc55567c))
* **providers:** pin accept-encoding so zstd bodies are not truncated ([3b3a80d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/3b3a80dfdbc14be9be17dd869b036c1a42537e6f))
* **providers:** radancy stops trusting totalResults, cache-busts JSON, retries every fetch ([#3839](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3839)) ([4086d45](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4086d4546b16b00d1de7b0b320933a83c7355835))
* **providers:** route feishu-jobs and mokahr id encoding through _safe-url ([fd3966a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fd3966aa50fbe8e2b603cf6a226c8b8ae777f3e1))
* **providers:** total_pages outranks a short page in the a16z sweep loop ([#2547](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/2547)) ([e34be83](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e34be83bd409c0e240aacfd4c31241472953707a))
* **providers:** validate resolved addresses before connecting (DNS rebinding guard) ([#3096](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3096)) ([d8d4d94](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d8d4d94a550d18aea45c137a3afbd6475586b8d6))
* **reconcile-pipeline:** validate CLI flags via the shared helper ([b4384a7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/b4384a797556250a2e73a23e40b3a0a8e13f332a))
* **rejection-latency:** report placeholder-employer applications instead of dropping them silently ([#3712](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3712)) ([d9fe917](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/d9fe9174d051a551dfd8b26ac4ece5445a509849))
* **rename-sync:** migrate 5 vulnerable call sites to renameSyncWithRetry ([#3046](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3046)) ([213c281](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/213c2815a53560cc9764295c3a298a4e53d7f7fa))
* **reply-matcher:** a partial role-word match must be a whole word ([#3535](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3535)) ([90d311f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/90d311f25684ed66180825d679ce78c38adb62e7))
* **reserve-report-num:** handle --help/-h explicitly ([#3569](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3569)) ([84693b4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/84693b407326e0ae65274e2eebaf613de890f515))
* resolve skill paths from project root ([#3332](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3332)) ([68bee94](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/68bee943ccd7e502807c38c5998f060cbb71cdea))
* **rheinmetall:** guard the slug-fallback decode against a malformed percent-escape ([6efda1c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6efda1c1003188d70a1323685d44fd3882e6c3ed))
* **role-matcher:** a level stated on both sides of a title must agree ([#3651](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3651)) ([dfeb2fc](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/dfeb2fccd4a0c2a27e666969823150b61ee91159))
* **salary-gap:** decide which separator is the decimal point before deleting either ([17f44f9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/17f44f977fbdd1e62a7f32241f8dc0f21aba410c))
* **salary-gap:** treat a period as thousands grouping, not a decimal point ([#3174](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3174)) ([b8e5bcb](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/b8e5bcb3d81ae68b3dd8055e71c2c248ebd21867))
* **scaffolder:** restore the published npm package name ([5e2bf5b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5e2bf5b9726097413294f3acffb3a2025ae9570f))
* **scan-ats-full:** collapse a Workday requisition served under several sites of one tenant ([#3446](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3446)) ([5c26e4a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5c26e4af43b89a11f79caa7592a1a2e03caeb55d))
* **scan-ats-full:** send the progress counter to stderr under --json ([fa6a84f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/fa6a84f48d949bd75ff5d94839494a1ef7a70a20))
* **scan:** do not block Dublin OH as Ireland ([#3633](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3633)) ([56429bf](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/56429bfaa07ec695581500fbfd12184e9ba43723))
* **scan:** Level 1 runs Playwright sequentially, matching the shared-session rule ([77eebc9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/77eebc95877d993fddca4c30aeee7eeff439bc65))
* **scan:** opt-in location-aware company+role dedupe ([#3751](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3751)) ([ae97912](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ae979122628b3c3b1746213c29af3a91f1b7f8ce)), closes [#3750](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3750)
* **scan:** opt-in word:/stem: anchoring for content_filter keywords ([ce3ac16](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ce3ac16bdd2438f5f4eea05ec8f03f8305e7f36c))
* **scan:** prioritize configured locations in Workday facet recovery ([#3851](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3851)) ([efede1c](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/efede1ce24257411629c37084e5e6c44428bf4e5)), closes [#3850](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3850)
* **scan:** resolve scanner user data against the data root, not the cwd ([#3511](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3511)) ([7d7b0f9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/7d7b0f97d447a2d1c72b7b3a24c9c99ebc9a5d7a)), closes [#3510](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3510)
* **scan:** three scanners stamp first_seen in UTC, the reader measures it in local ([#3070](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3070)) ([cc241ea](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/cc241eab47dc40e6ecb7e3c5a9b25884a7ff61ae))
* **set-status:** a transition into Applied seeds the follow-up from set-status itself ([#3470](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3470)) ([9312da7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9312da7ee49e24f496dcb81adec86530de644051)), closes [#3459](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3459)
* **set-status:** resolve --report links from the Notes cell on customized layouts ([#3075](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3075)) ([ae70a41](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ae70a410bc77552b6a52ad15ab1ecb78f41f2fa3))
* **skill-extract:** recognize marketing/GTM skills and stop reporting tracked employers as gaps ([#3537](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3537)) ([f8de04e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f8de04e20444fbd80d034c0d37fd3d47a82b0501))
* **stats,calibrate:** ledger-aware funnel + calibration ([#1428](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/1428), [#1724](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/1724)) ([34e5547](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/34e5547ada30afac4b536abe2de84bb04dadc019))
* **stats,calibrate:** reject malformed status ledger rows ([#3350](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3350)) ([0f645d2](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0f645d2fd60f37348587f1626861da650f4887a4))
* **stats:** stop reporting a neighbouring counter when scan-runs.tsv drifts ([5eb71d5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5eb71d5db82ad50de20f35e14823c33bef9fcc4f))
* **story-provenance:** make the context matcher script-aware, not ASCII-only ([2d7521e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/2d7521e9d753a6ccceadec9599d98a6c4e55811b))
* **templates:** honor profile font_family in the Traditional Chinese CV block ([#3525](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3525)) ([f0d2082](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f0d2082a4f2b7668e825016bccb18e219b3c982d)), closes [#3154](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3154)
* **templates:** keep CJK fallback fonts active for ja, zh-CN and ko ([#3531](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3531)) ([f3b7c60](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f3b7c60f18ff25e8122a3cea6d1e22c4005acae3))
* **templates:** make the CV template's second hardcoded color themeable ([#3699](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3699)) ([351f7f5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/351f7f5240b8ef1e7231cee7f906a583b7073834)), closes [#3695](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3695)
* **test-all:** discovered-suite guards ignore calls mentioned only in comments ([363b990](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/363b990eed503dca486c0e54b79358ebaa37ef2c))
* **test-all:** discovered-suite guards ignore calls mentioned only in comments ([e5c985d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e5c985d7d6f1dbf47f89bf4432bda890b117288f))
* **test:** handle terminal user-layer wildcards ([741f676](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/741f676089c43fecf1435425a8a9f58d99566401))
* **tests:** answer gitignore probes that cross a user-layer symlink ([#3598](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3598)) ([aa8832f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/aa8832f2c1795f2ae9e802d9eb5d20fb807f3e00))
* **tests:** assert the flag echo with includes instead of an unescaped RegExp ([743622d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/743622d382c415761172ec0c5b304a62bf3ae70c))
* **tests:** guard subtree-anchored walkers against nested checkouts ([#3792](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3792)) ([5726853](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5726853924fd5d2885413667fbbc0d06809cc3e9))
* **tests:** pass --confirm to apply in the local-paths regression leg ([#3755](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3755)) ([e979d4e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e979d4e04c35807a3905ebfb3cc87f8d621192ce))
* **tests:** scope the profile pin and move the last hand-registered suites ([0bcd0fa](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0bcd0fae30165b8c13d6b7fd6d28eda8e2fe367a))
* **tests:** skip nested checkouts by marker, not by the name .git ([#3681](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3681)) ([35a7cdb](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/35a7cdb22cd25fcb0ad59795606dfe660baf91c5)), closes [#3499](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3499)
* **tests:** stop the photo suite writing cv-preview.html into the user's data root ([#3599](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3599)) ([f1b7a8e](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/f1b7a8e582c385254539488fb7c82224a333a49a))
* **tkms:** re-encode the config locale, hoisted out of the row loop to fail loud ([5b8f1f0](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5b8f1f0d6cf5900c1cc557bd9c391239801fe4ff))
* **token-tracker:** add MiniMax-M3 and MiniMax-M2.7 rates ([#3800](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3800)) ([8aef9e0](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/8aef9e057472972987edca0e3b36fd23c865e283))
* **tracker:** carry the tracker layout through the export round-trip ([#3794](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3794)) ([4f12d84](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/4f12d845ed347766a808a1995f2a8bfdf1e6b48e)), closes [#3703](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3703)
* **tracker:** map "fecha" to the date column ([#3767](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3767)) ([843d179](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/843d179624e09c5b9bc9ec372a2b21dd338ef94e)), closes [#3705](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3705)
* **tracker:** reject malformed application IDs instead of coercing them ([#3485](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3485)) ([c68a7d4](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c68a7d46b6fe1e5869b8316b0814cc4c0675cd95))
...
* **tracker:** resolve templates/states.yml from the module, not the cwd ([#3509](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3509)) ([08b7f31](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/08b7f317b596fa010d06cd28f8a9b53799c02fd1)), closes [#3508](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3508)
* **tracker:** resolve the derived index path at call time, not at import ([#3507](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3507)) ([9bd4445](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9bd4445e25e1308aefe44e6f04c1750c373edaff))
* **tracker:** sort the applications table by # ascending on write ([#3515](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3515)) ([372cd04](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/372cd043b35e8d07cd522fec955a65252c0906db))
* **tracker:** strip invisible control characters at the cell sanitizer ([#3902](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3902)) ([dadc8f6](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/dadc8f645388678ae64e38300363586fd3a9fc24)), closes [#3892](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3892)
* **triage:** fall back to Playwright when WebFetch finds nothing ([#3571](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3571)) ([10b93a5](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/10b93a5f6e4444332243fefaef65b8b153835fc1))
* **triage:** weights sum to 1.00 and a test pins prose against the formula ([#3831](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3831)) ([6a8e876](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6a8e8762168f1302daaa6928460dd027a7c06596)), closes [#3738](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3738)
* **update-system:** apply() cannot commit when a path it stages is ignored or never tracked ([ae6909f](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ae6909f718c9316a0d1424379e1688f438a07706))
* **update-system:** never prune a file the update just preserved, or an asset it references ([c8afb5d](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/c8afb5d041a5d10d4634c4d28abd20dfe8efaf58))
* **update-system:** refuse to run when the install is not its own git toplevel ([aecae53](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/aecae537fe7cf52b1da92ff05aaa5976cf85d18f))
* **update:** drop the duplicate prune loop that deleted stale files twice ([#3208](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3208)) ([e50fbad](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e50fbad8ca5bc7f91ef568dc72c56c31b7285d52))
* **update:** point the updater at the repository's new home ([9063495](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/9063495036e253668e42d6bbbd4234e750b25782))
* **updater:** back up self-bootstrap edits before checkout ([#3474](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3474)) ([203c90b](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/203c90b79e632209e3a55068499f8ca5cbea489e))
* **update:** resolve preserved files before staging so :(exclude) never reaches --literal-pathspecs ([#3742](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3742)) ([bbfae51](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/bbfae511a84964177022bcf44cf7d93aa385390e)), closes [#3740](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3740)
* **updater:** parse git status with -z so quoted paths and renames match real files ([79152e7](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/79152e732ecddf587d6f4011903139b9fd06c612))
* **updater:** scope commits to shipped files ([#3688](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3688)) ([455bf37](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/455bf375a84508a955acd58819392fa9f7a07bd0))
...
* **verify-cv-facts:** a proposed plan horizon is not a metric claim ([#3656](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3656)) ([ad2e6e8](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/ad2e6e8cc41329855645bc5f2a07f6f3af0d49e3))
* **verify-cv-facts:** bind a count to the nearest metric noun, not the farthest ([#3465](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3465)) ([53620d3](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/53620d3bfaf10652bb8d746c73758ad5cda8fe5c))
* **verify-cv-facts:** require a real word, not a bare capital letter, for a title claim ([#3909](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3909)) ([914cac3](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/914cac3605dd2473d7765c31a7add127c3a1781d)), closes [#3907](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3907)
* **verify-cv-facts:** stop flagging ordinary prose as tool claims ([#3643](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3643)) ([6043ef8](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/6043ef811f2c3449ddfe1e658419526fe7aaeda2)), closes [#3639](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3639)
* **verify-cv-facts:** tell a disabled fact gate apart from one that ran clean ([#3901](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3901)) ([60f0146](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/60f014696822c1744794816c12e51f1bc1d840f2)), closes [#3894](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3894)
* **verify-pipeline:** recover a report number from a link target written with backslashes ([8177808](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/81778084cff5341a62026a936ccf616821a524de))
* **verify:** a check that could not run is a failure, not a warning ([5ae4337](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/5ae433780e5db2ad43a9365ae560bf3ae7a4f204))
...
* **workday:** recover offset-clamped tenants with a facet split ([#3310](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3310)) ([e268a5a](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/e268a5a226b15c8e695db923b85416423490bf65))
* **workday:** resolve a CXS-form URL as the endpoint, not as a careers page ([#3505](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3505)) ([0dbe4a9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/0dbe4a9129d3c3a5dbaec1c883320b327958f5ca))
* **workday:** tag a split whose chosen facet under-covers the board ([#3874](https://github.com/nirmalhk7/CareerOpsVOYAGER/issues/3874)) ([51a45d9](https://github.com/nirmalhk7/CareerOpsVOYAGER/commit/51a45d9c3802b0d8ab0de052dc723b2afd33df06))
